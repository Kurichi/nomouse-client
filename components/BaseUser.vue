...
<template>
  <div class="min-w-fit min-h-fit relative">
    ...
    <div
      v-if="showModal"
      class="w-36 absolute top-12 right-0 bg-slate-500 rounded-lg shadow py-5 flex flex-col items-center z-30"
    >
      <span
        class="w-fit text-sm cursor-pointer select-none text-white"
        @click="signOut()"
        >ログアウト</span
      >
    </div>
